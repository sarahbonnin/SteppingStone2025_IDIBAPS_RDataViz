...
# absolute path
geneexp <- read_csv("/users/sbonnin/DataViz_R/DataViz_source_files-main/files/expression_20genes.csv")
```
...
Because your **working directory** is */your_home_directory/*DataViz_R/, R can find the **DataViz_source_files-main** without requiring that you specify the whole path (**relative vs absolute path**).
